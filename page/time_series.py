...
STOCKS = np.array(["Select Stock","GOOG", "GME", "FB", "APL", "TSLA"])
...
def app():
	...
	window_selection_c.markdown("## Select time")  # add a title to the sidebar container
	...
	########################################## FORECAST #############################################
		...
		train_days = time_interval - TEST_INTERVAL_LENGTH
		...
		test_days = TEST_INTERVAL_LENGTH
